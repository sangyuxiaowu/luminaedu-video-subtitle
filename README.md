...
- 自定义背景颜色和透明度
- 调整字幕距离底部的距离
- 一键下载当前课程的 4 份字幕文件：原始英文、清洗英文、原始中文、清洗中文
...
3. 之后可通过视频区域下方的"关于插件"、"字幕设置"、"下载字幕"、"中文配音"、"配音设置"按钮使用各项功能
4. "关于插件"按钮可打开插件信息面板，查看作者和 GitHub 地址
5. 可在"中文配音"按钮右侧直接看到当前配音状态
6. 可通过"配音设置"按钮打开独立的小面板，调整语音、倍速和音量
7. 点击"下载字幕"会根据课程标题中的章节号导出 4 个 txt 文件，例如 3.1 会导出为 3-1e.txt、3-1e_cleaned.txt、3-1.txt、3-1_cleaned.txt
8. 调整设置后即时生效
